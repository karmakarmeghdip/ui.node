...
/**
 * Defines the style properties for a UI node.
 * This includes layout properties from Yoga, as well as visual properties for rendering.
 */
export type Style = {
  // Flexbox properties
...
/**
 * Applies a set of style properties to a Yoga layout node.
 * This function iterates through the style object and calls the corresponding
 * setter on the Yoga node for each layout-related property.
 * @param node The Yoga `Node` to apply the styles to.
 * @param style The `Style` object containing the properties to apply.
 */
